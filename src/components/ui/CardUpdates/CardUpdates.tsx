...
export const CardUpdates = ({categoryGame, nameGame, priceGame, coverGame, developerGame}: CardUpdatesProps) => {
    return(
        <div className="w-full max-w-[33.875rem] h-[7.75rem] flex gap-3 rounded-lg border border-border bg-gray-black">
            <div className="relative h-full w-[16rem]">
                ...
                <Image alt="cover game" src={coverGame} height={124} width={256} className="object-cover object-center"/>
            </div>
